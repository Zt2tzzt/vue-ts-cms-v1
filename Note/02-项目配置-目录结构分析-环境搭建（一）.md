...
2.安装 *cz-conventional-changelog*，并且初始化它，[参考文档](https://github.com/commitizen/cz-cli/issues/858)
...
2.在根目根录创建 `commitlint.config.js` 文件，配置 *commitlint*。
...
执行该命令后，*husky* 目录下生成 `commit-msg` 文件。
